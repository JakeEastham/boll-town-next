...
export const seasonPlayerStats: Record<string, PlayerSeasonStat[]> = {
  ...
  // In progress — last updated February 2026
  "2025-26": [
    { name: "Ewan Allabush", apps: 1, goals: 1 },
    { name: "Callum Atkinson", apps: 3, goals: 2 },
    { name: "Conor Beaden", apps: 6, goals: 0 },
    { name: "Daniel Bishop", apps: 3, goals: 0 },
    { name: "Edward Browne", apps: 1, goals: 0 },
    { name: "Joshua Connolly", apps: 16, goals: 10 },
    { name: "Joseph Coombs", apps: 17, goals: 1 },
    { name: "Thomas Devonport", apps: 1, goals: 0 },
    { name: "Jack Dillon", apps: 1, goals: 0 },
    { name: "Alfie Earith", apps: 20, goals: 10 },
    { name: "Luke Earl", apps: 1, goals: 0 },
    { name: "Jake Eastham", apps: 21, goals: 0 },
    { name: "Callum Evans", apps: 14, goals: 1 },
    { name: "Joe Eyre", apps: 1, goals: 1 },
    { name: "Beau Gatward", apps: 21, goals: 1 },
    { name: "Zach Gatward", apps: 3, goals: 0 },
    { name: "Sam Glover", apps: 10, goals: 1 },
    { name: "Declan Hanks", apps: 12, goals: 0 },
    { name: "Ally Harrison-Virani", apps: 16, goals: 2 },
    { name: "Jack Heppell", apps: 5, goals: 3 },
    { name: "Ryan Hibbert", apps: 9, goals: 0 },
    { name: "Alexander Howarth", apps: 3, goals: 0 },
    { name: "Matthew Joyce", apps: 20, goals: 0 },
    { name: "Finn Manning", apps: 13, goals: 1 },
    { name: "Philip Milsom", apps: 18, goals: 1 },
    { name: "Zak James Mousa", apps: 16, goals: 4 },
    { name: "Matthew Nelson", apps: 1, goals: 0 },
    { name: "Ted Palmer-Atkins", apps: 5, goals: 0 },
    { name: "George Richardson", apps: 17, goals: 3 },
    { name: "Harris Rollaston", apps: 1, goals: 0 },
    { name: "Arjun Takiar", apps: 2, goals: 0 },
    { name: "James Whitehead", apps: 1, goals: 0 },
    { name: "Daniel Williams", apps: 15, goals: 4 },
  ],
};
