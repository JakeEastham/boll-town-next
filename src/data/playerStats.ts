...
export const seasonPlayerStats: Record<string, PlayerSeasonStat[]> = {
  ...
  // In progress — last updated 7 March 2026
  "2025-26": [
    ...
    { name: "Declan Hanks", apps: 14, goals: 0 },
