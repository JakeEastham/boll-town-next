...
export const seasonPlayerStats: Record<string, PlayerSeasonStat[]> = {
  ...
  // In progress — last updated 28 March 2026
  "2025-26": [
    ...
    { name: "Alfie Earith", apps: 25, goals: 10 },
    ...
    { name: "Zach Gatward", apps: 7, goals: 0 },
    { name: "Sam Glover", apps: 12, goals: 1 },
    { name: "Declan Hanks", apps: 16, goals: 0 },
