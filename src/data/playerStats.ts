...
export const seasonPlayerStats: Record<string, PlayerSeasonStat[]> = {
  ...
  // In progress — last updated 21 August 2026 (v Lostock Gralam (A), lost 1-4, 18/08/26)
  "2026-27": [
    { name: "Abdoul Seye", apps: 1, goals: 0 },
    { name: "Alexander Howarth", apps: 1, goals: 0 },
    { name: "Alfie Earith", apps: 4, goals: 1 },
    { name: "Ally Harrison-Virani", apps: 1, goals: 0 },
    { name: "Arjun Takiar", apps: 2, goals: 0 },
    { name: "Daniel Williams", apps: 3, goals: 1 },
    { name: "Declan Hanks", apps: 4, goals: 1 },
    { name: "Finn Manning", apps: 4, goals: 0 },
    { name: "George Richardson", apps: 4, goals: 1 },
    ...
    { name: "Jake Bowers", apps: 3, goals: 0 },
    { name: "Jake Eastham", apps: 4, goals: 0 },
    { name: "Joshua Connolly", apps: 3, goals: 0 },
    { name: "Matthew Joyce", apps: 4, goals: 0 },
    { name: "Maxwell Berkeley", apps: 4, goals: 0 },
    { name: "Mouhamadou Bamba Seye", apps: 1, goals: 0 },
    { name: "Muhammad Abdullah Butt", apps: 3, goals: 1 },
    { name: "Philip Milsom", apps: 3, goals: 0 },
