 ...
 *
 * Last updated: 12 September 2026 (26/27 season in progress)
...
export const seasonPlayerStats: Record<string, PlayerSeasonStat[]> = {
  ...
  // Season complete — last updated 9 May 2026
  "2025-26": [
    { name: "Ewan Allabush", apps: 1, goals: 0 },
    { name: "Callum Atkinson", apps: 5, goals: 0 },
    { name: "Conor Beaden", apps: 6, goals: 0 },
    { name: "Daniel Bishop", apps: 3, goals: 0 },
    { name: "Maxwell Berkeley", apps: 5, goals: 0 },
    { name: "Edward Browne", apps: 2, goals: 0 },
    { name: "Joshua Connolly", apps: 22, goals: 13 },
    { name: "Joseph Coombs", apps: 18, goals: 1 },
    { name: "Thomas Devonport", apps: 1, goals: 0 },
    { name: "Jack Dillon", apps: 1, goals: 0 },
    { name: "Alfie Earith", apps: 30, goals: 13 },
    { name: "Luke Earl", apps: 3, goals: 1 },
    { name: "Jake Eastham", apps: 30, goals: 0 },
    { name: "Callum Evans", apps: 14, goals: 1 },
    { name: "Joe Eyre", apps: 1, goals: 1 },
    { name: "Beau Gatward", apps: 25, goals: 1 },
    { name: "Zach Gatward", apps: 12, goals: 0 },
    { name: "Sam Glover", apps: 15, goals: 1 },
    { name: "Declan Hanks", apps: 21, goals: 4 },
    { name: "Ally Harrison-Virani", apps: 24, goals: 7 },
    { name: "Jack Heppell", apps: 8, goals: 3 },
    { name: "Ryan Hibbert", apps: 15, goals: 0 },
    { name: "Alexander Howarth", apps: 3, goals: 0 },
    { name: "Matthew Joyce", apps: 29, goals: 0 },
    { name: "Finn Manning", apps: 18, goals: 1 },
    { name: "Philip Milsom", apps: 24, goals: 6 },
    { name: "Zak James Mousa", apps: 23, goals: 8 },
    { name: "Matthew Nelson", apps: 1, goals: 0 },
    { name: "Ted Palmer-Atkins", apps: 5, goals: 0 },
    { name: "George Richardson", apps: 24, goals: 4 },
  ...
  // In progress — last updated 12 September 2026 (v Vulcan FC (A), lost 1-2, 22/08/26; v St Michaels DH (H), won 4-1, 25/08/26; v St Helens Reserves (H), league GW8, 05/09/26; v Moreton FC (H), Cheshire Cup R1, won 4-1, 12/09/26)
  "2026-27": [
    { name: "Abdoul Seye", apps: 3, goals: 0 },
    { name: "Alexander Howarth", apps: 2, goals: 1 },
    { name: "Alfie Earith", apps: 9, goals: 3 },
    { name: "Ally Harrison-Virani", apps: 1, goals: 0 },
    { name: "Arjun Takiar", apps: 3, goals: 0 },
    { name: "Augustus Benne", apps: 1, goals: 0 },
    { name: "Daniel Williams", apps: 7, goals: 1 },
    { name: "Declan Hanks", apps: 7, goals: 1 },
    { name: "Finn Manning", apps: 8, goals: 0 },
    { name: "George Richardson", apps: 9, goals: 2 },
    { name: "Georgie Kilroe", apps: 3, goals: 0 },
    { name: "Ivan Otono", apps: 4, goals: 1 },
    { name: "Jack Heppell", apps: 2, goals: 1 },
    { name: "Jack Toft", apps: 3, goals: 0 },
    { name: "Jacob Hodgson", apps: 4, goals: 0 },
    { name: "Jake Bowers", apps: 7, goals: 0 },
    { name: "Jake Eastham", apps: 8, goals: 0 },
    { name: "Joshua Connolly", apps: 8, goals: 0 },
    { name: "Leon Bergin", apps: 1, goals: 0 },
    { name: "Matthew Joyce", apps: 9, goals: 0 },
    { name: "Maxwell Berkeley", apps: 6, goals: 0 },
    { name: "Mouhamadou Bamba Seye", apps: 4, goals: 0 },
    { name: "Muhammad Abdullah Butt", apps: 7, goals: 2 },
    { name: "Nelson Onwusiri", apps: 3, goals: 1 },
    { name: "Osvaldo Costa", apps: 2, goals: 0 },
    { name: "Philip Milsom", apps: 7, goals: 3 },
    { name: "Ruben Adrio", apps: 2, goals: 0 },
    { name: "Ryan Hibbert", apps: 4, goals: 0 },
    { name: "Tkai Myers-Jones", apps: 1, goals: 0 },
    { name: "Xavi Llorente", apps: 2, goals: 2 },
  ],
};
