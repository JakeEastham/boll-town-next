...
export const seasonPlayerStats: Record<string, PlayerSeasonStat[]> = {
  ...
  "2025-26": [
    ...
    { name: "Edward Browne", apps: 1, goals: 0 },
    { name: "Joshua Connolly", apps: 15, goals: 10 },
    { name: "Joseph Coombs", apps: 16, goals: 1 },
    { name: "Thomas Devonport", apps: 1, goals: 0 },
    { name: "Jack Dillon", apps: 1, goals: 0 },
    { name: "Alfie Earith", apps: 19, goals: 10 },
    { name: "Luke Earl", apps: 1, goals: 0 },
    { name: "Jake Eastham", apps: 20, goals: 0 },
    { name: "Callum Evans", apps: 14, goals: 1 },
    { name: "Joe Eyre", apps: 1, goals: 1 },
    { name: "Beau Gatward", apps: 20, goals: 1 },
    { name: "Zach Gatward", apps: 2, goals: 0 },
    { name: "Sam Glover", apps: 9, goals: 1 },
    { name: "Declan Hanks", apps: 11, goals: 0 },
    { name: "Ally Harrison-Virani", apps: 15, goals: 2 },
    { name: "Jack Heppell", apps: 5, goals: 3 },
    { name: "Ryan Hibbert", apps: 8, goals: 0 },
    { name: "Alexander Howarth", apps: 3, goals: 0 },
    { name: "Matthew Joyce", apps: 19, goals: 0 },
    { name: "Finn Manning", apps: 12, goals: 1 },
    { name: "Philip Milsom", apps: 17, goals: 1 },
    { name: "Zak James Mousa", apps: 15, goals: 4 },
    { name: "Matthew Nelson", apps: 1, goals: 0 },
    { name: "Ted Palmer-Atkins", apps: 5, goals: 0 },
    { name: "George Richardson", apps: 16, goals: 3 },
