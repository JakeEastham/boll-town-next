...
const seasons = [
  ...
  },
  {
    ...
    topScorers: [
      { name: "Joshua Connolly", goals: 13 },
      { name: "Alfie Earith", goals: 13 },
      { name: "Zak James Mousa", goals: 8 },
      { name: "Ally Harrison-Virani", goals: 7 },
      { name: "Philip Milsom", goals: 6 },
    ],
    topAppearances: [
      { name: "Alfie Earith", apps: 30 },
      { name: "Jake Eastham", apps: 30 },
      { name: "Matthew Joyce", apps: 29 },
      { name: "Beau Gatward", apps: 25 },
      { name: "Daniel Williams", apps: 25 },
    ],
